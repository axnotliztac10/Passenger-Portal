angular.module('blackRide').controller('confirmController',
    ...
    $scope.map = {
        ...
        events: {
            idle: function (map, res1) {
                ...
                $scope.markers.push({
                    icon: {
                        url: HOST + 'assets/imgs/a' + $rootScope.theme + '@2x.png',
                ...
                if (posDro) {
                    $scope.markers.push({
                        icon: {
                            url: HOST + 'assets/imgs/b' + $rootScope.theme + '@2x.png',
                            scaledSize: new google.maps.Size(36, 50),
                            anchor: new google.maps.Point(18, 50)
                        },
                        options: { draggable: false },
                ...
                $scope.markers.push({
                    icon: {
                        ...
                        scaledSize: new google.maps.Size(64, 71)
                    },
                    options: { draggable: false },
                    latitude: lat,
                    longitude: lng,
    ...
    $scope.setDriverImage = function (position, map) {
        ...
        var contentString = "<div id='content' style='width: 50px;border-radius: 50%;margin-top: 17px;overflow: hidden;height: 49px;'><img style='width:100%' src='" + $rootScope.user.booking.driver_info.driver.logo_url_small + "'></div>";

        infowindow = new InfoBox({
            content: contentString,
            disableAutoPan: true,
            pixelOffset: new google.maps.Size(-25, -82),
            position: position,
            boxStyle: {
                width: "50px"
            }
