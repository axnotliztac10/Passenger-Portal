angular.module('blackRide').controller('confirmController',
    ...
    $scope.setDriverImage = function (position, map) {
        ...
        var contentString = "<div id='content' style='width: 48px;border-radius: 50%;overflow: hidden;height: 48px;'><img style='width:100%' src='" + $rootScope.user.booking.driver_info.driver.logo_url_small + "'></div>";
